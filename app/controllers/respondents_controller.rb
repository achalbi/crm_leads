class RespondentsController < ApplicationController
  ...
  private
    ...
    def respondent_params
      params.require(:respondent).permit(:title, :name, :lead_date, :email, :lead_source, :select_executive, :phone, :lead_type, :company_name, :company_address, :site_name, :site_address)
    end
end
